...
export const shipStats = {
	"Bartali Sailboat": {
		...
		note: 'The purchased hull every Epheria ship begins from. Its one cannon a side is fired standing at it.'
	},
	"Epheria Sailboat": {
		durability: 1000000, rations: 1000000, weight: 5000, slots: 25,
		cabins: 10, crew: 2, cannons: 1, reload: 17,
		speed: 100, accel: 100, turn: 110, brake: 110,
		note: 'Cargo over guns: five thousand LT and twenty-five slots, one cannon a side.'
	},
	"Improved Epheria Sailboat": {
		durability: 1000000, rations: 1000000, weight: 5000, slots: 25,
		cabins: 10, crew: 2, cannons: 2, reload: 13,
		speed: 100, accel: 100, turn: 110, brake: 110,
		note: 'The same hull with a second cannon a side, fired from the wheel.'
	},
	"Epheria Frigate": {
		...
		note: 'Guns over cargo: two cannons a side, faster and tougher, twelve slots.'
	},
	"Improved Epheria Frigate": {
		durability: 1200000, rations: 1000000, weight: 4000, slots: 12,
		cabins: 10, crew: 2, cannons: 4, reload: 13,
		speed: 110, accel: 110, turn: 120, brake: 120,
		note: 'Four cannons a side, fired from the wheel.'
	},
	"Epheria Caravel": {
		durability: 1000000, rations: 1100000, weight: 10000, slots: 30,
		cabins: 30, crew: 6, cannons: 2, reload: 13,
		speed: 100, accel: 100, turn: 110, brake: 110,
		note: 'The trading hull: ten thousand LT, thirty slots, six sailors.'
	},
	"Epheria Galleass": {
		durability: 1200000, rations: 1200000, weight: 8000, slots: 15,
		cabins: 30, crew: 6, cannons: 4, reload: 13,
		speed: 110, accel: 110, turn: 120, brake: 120,
		note: 'The fighting hull: four cannons a side, six sailors, eight thousand LT.'
	},
	"Carrack (Advance)": {
		...
		note: 'The barter Carrack: the most weight and slots of the four, and the toughest.'
	},
	"Carrack (Balance)": {
		...
		note: 'Nearly the Advance\'s hold, a little more speed, a second faster on the cannons.'
	},
	"Carrack (Volante)": {
		durability: 1250000, rations: 1400000, weight: 13500, slots: 20,
		cabins: 110, crew: 20, cannons: 9, reload: 12,
		speed: 120, accel: 110, turn: 125, brake: 125,
		note: 'The fastest hull in the game short of the guild Galleon; twenty slots is the price.'
	},
	"Carrack (Valor)": {
		...
		note: 'The hunting Carrack: the fastest reload, the deepest rations, and the Volante\'s handling.'
	},
	"Panokseon": {
		...
		note: 'Two million durability and the widest cabin space of any hull; slower than a Carrack, and it rams harder.'
	},
	"Epheria Cog": {
		...
		lifespan: 500000,
		note: 'A throwaway runabout: no sailors, no cannons, no bartering, and a lifespan of 500,000 that repairs cannot restore. Quicker than anything above it.'
	},
	"Rowboat": {
		durability: 70100, rations: 235200, weight: 360, slots: 8,
		cabins: 0, crew: 0, cannons: 0, reload: 0,
		speed: 100, accel: 100, turn: 105, brake: 100,
		note: 'Enough boat for the coast and the first Great Ocean errands.'
	},
	"Calpheon Rowboat": {
		durability: 70100, rations: 235200, weight: 450, slots: 8,
		cabins: 0, crew: 0, cannons: 0, reload: 0,
		speed: 100, accel: 100, turn: 105, brake: 100,
		note: 'The Rowboat with a little more weight allowance.'
	},
	"Mediah Rowboat": {
		durability: 70100, rations: 235200, weight: 360, slots: 8,
		cabins: 0, crew: 0, cannons: 0, reload: 0,
		speed: 100, accel: 100, turn: 105, brake: 100,
		note: 'The Rowboat built from Mediah\'s materials.'
	},
	"Raft": {
		durability: 40100, rations: 85680, weight: 180, slots: 4,
		cabins: 0, crew: 0, cannons: 0, reload: 0,
		speed: 100, accel: 100, turn: 100, brake: 100,
		note: 'Twenty-five logs and some powder. It floats.'
	}
};
...
export function statsLine(ship) {
	...
	if (!s) return '';
	const bits = [`${s.weight.toLocaleString()} LT`, `${s.slots} slots`];
	if (s.crew) bits.push(`${s.crew} sailors`);
	if (s.cannons) bits.push(`${s.cannons} cannon${s.cannons > 1 ? 's' : ''} a side`);
	bits.push(`speed ${s.speed}%`);
	return bits.join(' · ');
}
