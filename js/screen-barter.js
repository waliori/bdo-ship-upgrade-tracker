...
import { snapshot, barterData, barterProfile, combos, SILVER } from './ui-state.js';
...
function persist() {
	try {
		localStorage.setItem(STORE_KEY, JSON.stringify({ goal, item, qty, port, routes, stash, board, sail }));
