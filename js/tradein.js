...
export const barters = {
	...
	"Brilliant Rock Salt Ingot": [{"count": "1", "input": ["[Level 5] Azure Quartz", "[Level 5] Portrait of the Ancient", "[Level 5] Luxury Patterned Fabric", "[Level 5] 102 Year Old Golden Herb", "[Level 5] Stuffed White Caterpillar"]}],
	...
	"Great Ocean Dark Iron": [{"count": "3-5", "input": ["[Level 4] Opulent Thread Spool", "[Level 4] Green Salt Lump", "[Level 4] Panacea"]}],
