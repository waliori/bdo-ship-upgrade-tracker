...
export const CHANGES = [
	{
		...
		notes: [
			...
			'On the Barter tab, <b>Today’s material list</b> is the page’s width and its first panel — the material, the want and the harbour on it, the give groups in columns — with the run it makes and the hold it draws on side by side beneath. On the Map, the busy corner of the Ross Sea under the hekaru and ocean stalker grounds no longer stutters: the pins move without a layout, and their words are written only when they change.'
		]
	},
	{
		date: '2026-09-03',
