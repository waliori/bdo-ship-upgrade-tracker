...
export const CHANGES = [
	{
		...
		notes: [
			...
			'Ocean currents, traced by hand: draw a line the way a current runs in Draw mode and keep it <b>as a current</b>, and the chart draws it as an arrowed band and times every route through it — a leg riding it at 1.7× the ship’s speed, the community figure, which each current can carry its own timed pace instead. Against a current nothing is claimed. The route’s distance says how much of it is on a current, and each such leg wears a ≋.'
		]
	},
	{
		date: '2026-09-02',
