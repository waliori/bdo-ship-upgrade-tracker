...
export const CHANGES = [
	{
		...
		notes: [
			...
			'<b>And the counts are read off the pixels too \u2014 no OCR engine is fetched for a storage at all.</b> An engine is the wrong tool for eight-pixel writing over a drawing, and the first version proved it: half the counts came back wrong. What works is what the game\u2019s own rendering guarantees. The count is <i>not</i> the palest thing on a slot \u2014 over a white icon the figures reach 143 where the drawing reaches 198 \u2014 but it is always <b>stroked</b>, with the game\u2019s dark outline on both sides of every upright, which a drawing\u2019s edge never has. And every count in a window stands on <b>one line, at one height, against one margin</b>: measured across four screenshots at two resolutions, the baseline scatters by three tenths of a pixel. So the line is found once from every slot at once, and each count is read right to left as a row of boxes of known size against <b>the game\u2019s own figures</b>, learnt from 391 of them off shots whose numbers were known. The figures are carried as two sets \u2014 as a PNG crop renders them and as the game\u2019s own JPEG does, kept apart rather than averaged, since the compression fills in the very outline the reading depends on. On a PNG crop that is <b>102 of 117 counts exactly, two wrong</b>; on the game\u2019s own JPEG, <b>26 of 57</b>. What cannot be read says so, with the corner of the slot beside it to type over.',
